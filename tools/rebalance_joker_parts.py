...
HULL = {
    ...
    "hull_azure_collector": [fx("sampleSellValue", 9)],
    "hull_ember_vent": [fx("luck", 8)],
    ...
    "hull_ember_core": [fx("speed", 5), fx("luck", 8)],
    "hull_star_compass": [fx("speed", 5), fx("hullRegen", 5)],
    "hull_ember_plating": [fx("hullDurability", 6), fx("shopDiscount", 8)],
...
ENGINE = {
    ...
    "engine_azure_coolant_jet": [fx("speed", 5), fx("collisionRadius", 8)],
    "engine_ember_burst_valve": [fx("boostCharge", 4), fx("speed", 8)],
