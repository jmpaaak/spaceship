...
- R1 (Lane C): extract `testGearRunEffectWiring` from `game/self_test.lua` into one `game/tests/legacy_*.lua` module, preserving chain-trigger, reroll, detection-radius, and auto-collect assertions.
