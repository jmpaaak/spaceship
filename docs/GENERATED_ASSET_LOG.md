...
2026-09-04T06:15:54+0900 | assets/effects/shop_ship_preview.png | ComfyUI-generated 64x64 cyan arrowhead scout-hull EARTH SHOP shipPreviewCompact icon (seed 20260904168), wired into PlayScene as self.shipPreviewIconImage, replaces the bare shipPreviewCompact printf with an icon+label pair
2026-09-04T06:20:22+0900 | assets/effects/shop_next_ship.png | ComfyUI-generated 64x64 gold hangar-roof EARTH SHOP nextLaunch.ship icon (seed 20260904169), wired into PlayScene as self.nextShipIconImage, replaces the bare nextLaunch.ship printf with an icon+label pair
2026-09-04T06:25:12+0900 | assets/effects/loadout_ship.png | ComfyUI-generated 64x64 gold hexagonal nameplate LAUNCH LOADOUT loadout.ship icon (seed 20260904170), wired into PlayScene as self.loadoutShipIconImage, replaces the bare loadout.ship printf with an icon+label pair
2026-09-04T06:29:11+0900 | assets/effects/destroyed_next_ship.png | ComfyUI-generated 64x64 gold restart-hull dart destroyed-phase next_ship_line icon (seed 20260904171), wired into PlayScene as self.destroyedNextShipIconImage, replaces the bare next_ship_line printf with an icon+label pair
2026-09-04T06:32:53+0900 | assets/effects/destroyed_tap_start_over.png | ComfyUI-generated 64x64 gold restart-loop hexagon destroyed-phase tap_start_over icon (seed 20260904172), wired into PlayScene as self.destroyedTapStartOverIconImage, replaces the bare tap_start_over printf with an icon+label pair
2026-09-04T06:37:11+0900 | assets/effects/destroyed_lost_total.png | ComfyUI-generated 64x64 gold cracked-coin octagon destroyed-phase lost_total_line icon (seed 20260904173), wired into PlayScene as self.destroyedLostTotalIconImage, replaces the bare lost_total_line printf with an icon+label pair
2026-09-04T06:41:09+0900 | assets/effects/destroyed_samples_settlement.png | ComfyUI-generated 64x64 cyan hexagonal sample-crystal destroyed-phase samples_settlement_line icon (seed 20260904174), wired into PlayScene as self.destroyedSamplesSettlementIconImage, replaces the bare samples_settlement_line printf with an icon+label pair
2026-09-04T06:45:13+0900 | assets/effects/destroyed_spins_settlement.png | ComfyUI-generated 64x64 cyan spinning slot-reel destroyed-phase spins_settlement_line icon (seed 20260904175), wired into PlayScene as self.destroyedSpinsSettlementIconImage, replaces the bare spins_settlement_line printf with an icon+label pair
...
2026-09-09T04:04:31+0900 | assets/planet/studio/hub_neptune.png | INBOX (78) Lane D: approved NASA PIA00046 Asset Studio 128x128 RGBA derivative wired for ice-type hub planets via dedicated runtime manifest
