...
locales.en = {
    ...
    earth_gear_bought_message = "EARTH GEAR BOUGHT: %s  BALANCE $%d",
    item_earth_gear = "EARTH GEAR",
    all_earth_gear_owned_message = "ALL EARTH GEAR OWNED  BALANCE $%d",
    earth_shop_slot_result = "SLOT %s +$%d  BALANCE $%d",
    item_earth_shop_slot = "SLOT SPIN",
...
locales.ko = {
    ...
    earth_gear_bought_message = "지구 장비 구매: %s  잔액 $%d",
    item_earth_gear = "지구 장비",
    all_earth_gear_owned_message = "지구 장비 모두 보유  잔액 $%d",
    earth_shop_slot_result = "슬롯 %s +$%d  잔액 $%d",
    item_earth_shop_slot = "슬롯 스핀",
