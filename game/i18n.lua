...
locales.en = {
    ...
    star_well_timer = "STAR APPROACH %.1f / %ds",
    ...
    ship_stats_speed = "SPEED LV.%d",
    ship_stats_hull = "HULL LV.%d",
    ship_stats_harvest = "HARVEST LV.%d",
    ship_stats_samples_label = "SELLABLE SAMPLES",
    ship_stats_samples = "SAMPLES %d  $%d",
    hub_label = "HUB",
    shop_label = "SHOP",
...
locales.ko = {
    ...
    ship_stats_speed = "속도 LV.%d",
    ship_stats_hull = "내구 LV.%d",
    ship_stats_harvest = "수확 LV.%d",
    ship_stats_samples_label = "판매 가능 표본",
    ship_stats_samples = "표본 %d  $%d",
    hub_label = "HUB",
    shop_label = "SHOP",
