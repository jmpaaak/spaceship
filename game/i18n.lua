...
locales.en = {
    ...
    hud_primary = "DIST %04d  CASH $%d",
    hud_status = "F%03d H%d/%d %-6s S%02d",
    forecast_line = "NO-HIT %d  SLOTS %d",
    loadout_ship = "SHIP %s",
    stats_line = "MAX FUEL %d  HULL %d",
    ...
    ship_preview_line = "%s MAX FUEL %d  HULL %d",
    ship_preview_compact = "%s F%d H%d",
    fuel_action_line = "T/F FUEL LV.%d>%d $%d",
    ...
    fuel_upgraded_message = "FUEL TANK UPGRADED  LV.%d  MAX %d  %s  BALANCE $%d",
    hull_upgraded_message = "HULL UPGRADED  LV.%d  MAX FUEL %d  HULL %d  %s  BALANCE $%d",
    item_fuel_upgrade = "FUEL UPGRADE",
    ...
    scout_purchased_message = "SCOUT PURCHASED AND SELECTED  MAX FUEL %d  HULL %d  %s  BALANCE $%d",
    item_scout = "SCOUT",
    ship_selected_message = "%s SELECTED  MAX FUEL %d  HULL %d  %s",
...
locales.ko = {
    ...
    hud_primary = "거리 %04d  자금 $%d",
    hud_status = "F%03d H%d/%d %-6s S%02d",
    forecast_line = "무피격 %d  슬롯 %d",
    loadout_ship = "함선 %s",
    stats_line = "최대연료 %d  선체 %d",
    ...
    ship_preview_line = "%s 최대연료 %d  선체 %d",
    ship_preview_compact = "%s F%d H%d",
    fuel_action_line = "T/F 연료 LV.%d>%d $%d",
    ...
    fuel_upgraded_message = "연료탱크 업그레이드  LV.%d  최대 %d  %s  잔액 $%d",
    hull_upgraded_message = "선체 업그레이드  LV.%d  최대연료 %d  선체 %d  %s  잔액 $%d",
    item_fuel_upgrade = "연료 업그레이드",
    ...
    scout_purchased_message = "정찰선 구매완료  최대연료 %d  선체 %d  %s  잔액 $%d",
    item_scout = "정찰선",
    ship_selected_message = "%s 선택  최대연료 %d  선체 %d  %s",
