...
locales.en = {
    ...
    credits_role = "Design · Development",
    credits_contact = "jmpaxk@gmail.com (jimmy)",
    credits_engine = "Engine LÖVE 11.5 · Korean pixel font Galmuri",
    credits_back = "BACK",
...
locales.ko = {
    ...
    credits_role = "기획 · 개발",
    credits_contact = "jmpaxk@gmail.com (jimmy)",
    credits_engine = "엔진 LÖVE 11.5 · 한글 픽셀 폰트 Galmuri",
    credits_back = "돌아가기",
