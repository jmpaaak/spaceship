...
function M:draw()
    ...
    elseif self.expedition.phase == "settlement" then
        love.graphics.setColor(0.02, 0.03, 0.08, 0.92)
        love.graphics.rectangle("fill", 12, 100, viewport.width - 24, 208)
        love.graphics.setColor(0.7, 0.9, 1)
        love.graphics.printf("EARTH SHOP", 16, 104, viewport.width - 32, "center")
        love.graphics.setColor(1, 0.8, 0.3)
        love.graphics.printf(string.format("SETTLEMENT TOTAL $%d", self.expedition.lastSettlement), 16, 117, viewport.width - 32, "center")
        love.graphics.setColor(0.75, 0.9, 1)
        love.graphics.printf(string.format("SAMPLES $%d", self.expedition.lastSampleSettlement), 16, 130, 76, "left")
        love.graphics.printf(string.format("SLOTS $%d", self.expedition.lastSlotSettlement), 92, 130, 72, "right")
