...
function M.run()
    ...
    assert(shopScene.message
        == "HULL UPGRADED  LV.1  HULL 4  NO-HIT 720  SLOTS 8  BALANCE $10")
    ...
    assert(shopScene.message
        == "SCOUT PURCHASED AND SELECTED  HULL 3  NO-HIT 960  SLOTS 10  BALANCE $20")
    ...
    assert(scoutHullMessageScene.message
        == "HULL UPGRADED  LV.1  HULL 3  NO-HIT 840  SLOTS 9  BALANCE $20")
    ...
    repeatedUpgradeMessageScene:keypressed("h")
    assert(repeatedUpgradeMessageScene.message
        == "HULL UPGRADED  LV.2  HULL 5  NO-HIT 840  SLOTS 9  BALANCE $0")
