...
function M.run()
    ...
    assert(starterNextLaunch.fuelAction == "T/F FUEL L0 +20 $50")
    assert(starterNextLaunch.fuelStatus == "SHORT" and not starterNextLaunch.fuelAffordable)
    assert(starterNextLaunch.hullAction == "T/H HULL L0 +1 $75")
    assert(starterNextLaunch.hullStatus == "SHORT" and not starterNextLaunch.hullAffordable)
    assert(starterNextLaunch.shipStatus == "SHORT" and not starterNextLaunch.shipAffordable)
    ...
    assert(fuelReadyNextLaunch.hullStatus == "SHORT" and not fuelReadyNextLaunch.hullAffordable)
    assert(fuelReadyNextLaunch.shipStatus == "SHORT" and not fuelReadyNextLaunch.shipAffordable)
    nextLaunchScene.expedition.money = nextLaunchScene.expedition.fuelUpgradeCost
